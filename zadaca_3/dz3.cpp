...
int main()
{
	...
	Sphere s2(Vec3f(-3, 0, -16), 2, green);
	Cuboid surface(Vec3f(-50, -7, -30), Vec3f(50, -7.001, -10), blue);
	Cuboid c(Vec3f(-8, -7.002, -16), Vec3f(-5, -4, -13), gray);

	Model p("./prism.obj", 1, Vec3f(2, 5, -15), green);

    Objects objs = { &s1, &s2, &surface, &c, &p };
	...
	Camera cam2(Vec3f(0, 0, 5), Vec3f(0, 0, -2), 0)
	...
	render(view2, objs, cam1, lights, env, "./view3.ppm");
	render(view2, objs, cam2, lights, env, "./view4.ppm");
